...
from langchain_community.document_loaders import YoutubeAudioLoader, GoogleSpeechToTextLoader
...
def get_video_transcript(url):
    ...
    # loader = GenericLoader(
    #     YoutubeAudioLoader(urls=[url], save_dir=target_dir),
    #     GoogleSpeechToTextLoader(project_id=project_id, file_path=target_dir)
    # )
